...
- `real_web_recipes_1629_20260708.csv`: 1,629 real webpage recipes exported
  from PostgreSQL after Indian Healthy Recipes plus Hebbars Kitchen crawling,
  parser cleanup, and localized-page pruning.
...
```bash
python -m services.reports.export_production_web_recipes --output data/datasets/production/real_web_recipes_1629_20260708.csv
```
